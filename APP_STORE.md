# APP_STORE.md — Textos de App Store para MathGame v2.0.0

Todos los textos listos para pegar en App Store Connect. Respetan los límites de Apple:
- **Nombre de la app:** ≤ 30 caracteres
- **Subtítulo:** ≤ 30 caracteres
- **Texto promocional:** ≤ 170 caracteres (editable sin nueva revisión)
- **Descripción:** ≤ 4000 caracteres
- **Keywords:** ≤ 100 caracteres, separadas por coma, sin espacios
- **Novedades (What's New):** ≤ 4000 caracteres

Idiomas: **English (en)**, **Español (es)**, **Français (fr)**, **Português do Brasil (pt-BR)**.
...
### App Name (30)
`Math Game: Daily Brain Train`

### Subtitle (30)
`Daily math challenge & streaks`

### Promotional Text (170)
`New in 2.0: a Daily Challenge for everyone, streaks, levels, Game Center leaderboards, four new modes, and full support on iPhone, iPad, Apple Watch and Mac.`

### Keywords (100)
`math,brain training,daily,mental math,multiplication,times tables,quiz,numbers,puzzle,kids,study`

### Description
```
Sharpen your mind one day at a time.

Math Game turns mental arithmetic into a habit you'll actually keep. A new Daily Challenge every day, the same questions for everyone, and a streak that's only yours to lose.
...
### Nombre (30)
`Math Game: Reto Mental`

### Subtítulo (30)
`Reto diario de mates y rachas`

### Texto promocional (170)
`Novedad 2.0: un Reto Diario para todos, rachas, niveles, rankings de Game Center, cuatro modos nuevos y soporte en iPhone, iPad, Apple Watch y Mac.`

### Keywords (100)
`matematicas,calculo mental,reto diario,multiplicar,tablas,division,quiz,numeros,cerebro,estudiar,juego`

### Descripción
```
Afila tu mente un día a la vez.

Math Game convierte el cálculo mental en un hábito que de verdad vas a mantener. Un nuevo Reto Diario cada día, las mismas preguntas para todos, y una racha que solo tú puedes perder.
...
### Nom (30)
`Math Game : Défi Mental`

### Sous-titre (30)
`Défi maths quotidien & séries`

### Texte promotionnel (170)
`Nouveau en 2.0 : un Défi Quotidien pour tous, séries, niveaux, classements Game Center, quatre nouveaux modes et support iPhone, iPad, Apple Watch et Mac.`

### Mots-clés (100)
`maths,calcul mental,defi quotidien,multiplication,tables,division,quiz,nombres,cerveau,reviser,jeu`

### Description
```
Aiguisez votre esprit, un jour à la fois.

Math Game transforme le calcul mental en une habitude que vous tiendrez vraiment. Un nouveau Défi Quotidien chaque jour, les mêmes questions pour tous, et une série que vous seul pouvez perdre.
...
### Nome (30)
`Math Game: Desafio Mental`

### Subtítulo (30)
`Desafio diário de mat. e foco`

### Texto promocional (170)
`Novo na 2.0: um Desafio Diário para todos, sequências, níveis, rankings do Game Center, quatro modos novos e suporte em iPhone, iPad, Apple Watch e Mac.`

### Palavras-chave (100)
`matematica,calculo mental,desafio diario,multiplicacao,tabuada,divisao,quiz,numeros,cerebro,estudar,jogo`

### Descrição
```
Afie sua mente, um dia de cada vez.

O Math Game transforma o cálculo mental em um hábito que você vai manter de verdade. Um novo Desafio Diário todo dia, as mesmas perguntas para todos, e uma sequência que só você pode perder.
...
## Captions de screenshots (sugeridas, todos los idiomas)

| # | Pantalla | EN | ES | FR | PT-BR |
|---|---|---|---|---|---|
| 1 | Daily | A new challenge every day | Un reto nuevo cada día | Un nouveau défi chaque jour | Um novo desafio todo dia |
| 2 | Racha/Profile | Keep your streak alive | Mantén viva tu racha | Gardez votre série | Mantenha sua sequência |
| 3 | Time Attack | 60 seconds. Go fast. | 60 segundos. Rápido. | 60 secondes. Vite. | 60 segundos. Rápido. |
| 4 | iPad split | Built for iPad | Hecho para iPad | Conçu pour iPad | Feito para iPad |
| 5 | Logros | 20 achievements to unlock | 20 logros por desbloquear | 20 succès à débloquer | 20 conquistas a desbloquear |

---

## Datos de privacidad (App Privacy — App Store Connect)

- **Datos recopilados:** ninguno con fines de seguimiento.
- **Game Center:** usa el identificador de jugador de Apple (gestionado por Apple, no por ti). Decláralo como "Identificadores → ID de usuario", no vinculado a la identidad y no usado para seguimiento.
- **Notificaciones locales:** no implican recolección de datos.
- **Sin analítica de terceros, sin SDKs de publicidad.**

## Notas de negocio

- **Modelo:** pago único (sin IAP, sin suscripción). Mantener.
- **Precio:** subir el tier respecto a v1; justificado por el salto mayor de versión. Los compradores de v1 obtienen v2 gratis (mismo bundle ID `com.faacil.MathGame`).
- **Edad:** 4+ (sin contenido sensible). Nota: NO usar la categoría "Kids" porque bloquea Game Center.
